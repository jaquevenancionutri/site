...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white font-montserrat">
      ...
      <section id="about-me" className="relative bg-jaque-purple text-white py-20">
        ...
        <div className="absolute bottom-0 w-full">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" transform="scale(-1, 1)" className="w-full h-auto">
            ...
            <path fill="#F18C27" d="M1000 100H0V48c62.5 24 125 48 250 48 250 0 250-96 500-96 125 0 187.5 24 250 48v52z"></path>
          </svg>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section id="reach-me" className="relative bg-jaque-gray py-20">
        <div className="container mx-auto px-8">
